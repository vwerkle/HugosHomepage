...
def moonshot():
    sorted_groups=process_groups("data/moonshot/moonshot.json")
    print(sorted_groups)
    return render_template('moonshot/moonshot.html', groups=sorted_groups)

@moonshot_mike_bp.route("/wittle_mike")
def moonshotwm():
    sorted_groupswm=process_groups("data/moonshot/players_seamo.json")
    print(sorted_groupswm)
    return render_template('moonshot/moonshot.html',groups=sorted_groupswm)